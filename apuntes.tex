...
{\bf Práctica propuesta}:

\begin{enumerate}
\item
  Modifica la arquitectura: Añade una tercera capa oculta de 32
  neuronas.

\item Cambia el Optimizador: Cambia optim.Adam por optim.SGD (Stochastic
Gradient Descent).

\item
  Observa: Mira qué pasa con la running\_loss. Verás que con SGD el
  error baja mucho más lento que con Adam. Ahí entenderás por qué Adam
  es el rey.
\end{enumerate}
